package com.example.muneeb.uokdriver;
...
import com.example.muneeb.uokdriver.Common.Common;
...
public class Welcome extends FragmentActivity implements OnMapReadyCallback,
    ...
    MaterialAnimatedSwitch location_update;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mapFragment = (SupportMapFragment) getSupportFragmentManager()
        ...
        location_update.setOnCheckedChangeListener(new MaterialAnimatedSwitch.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(boolean b) {
                if(b){
                    if (!location.hasLocationEnabled()) {
                        // ask the user to enable location access
                        SimpleLocation.openSettings(Welcome.this);
                    }else {
                        if(!isTimer){
                            isTimer = true;
                            t = new Timer();
            ...
            public void run() {
                ...
                handler1.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //getDirection(location.getLongitude() + 2,location.getLatitude() + 2);
    ...
    private void getDirection(double lat,double long1)
    {
        if(lat == 0 && long1 == 0){
            currentPosition = new LatLng(mLastLocation.getLatitude(),mLastLocation.getLongitude());
        }else{
            currentPosition = new LatLng(lat,long1);
        }
